...
def gradient(img):
    ...
    G = np.sqrt(part_x**2 + part_y**2)
    theta = np.arctan2(part_y, part_x)* 180 / np.pi
    ...
    for m in range(1,H-1):
        for n in range(1,W-1):            
            if(theta[m,n]==0 or theta[m,n]==180):
                if(G[m,n]>G[m+1,n] and G[m,n]>G[m-1,n]):
                    out[m,n] = G[m,n]
            if(theta[m,n]==45 or theta[m,n]==225):
                if(G[m,n]>G[m+1,n+1] and G[m,n]>G[m-1,n-1]):
                    out[m,n] = G[m,n]
            if(theta[m,n]==90 or theta[m,n]==270):
                if(G[m,n]>G[m,n+1] and G[m,n]>G[m,n-1]):
                    out[m,n] = G[m,n]
            if(theta[m,n]==135 or theta[m,n]==315):
                if(G[m,n]>G[m+1,n-1] and G[m,n]>G[m-1,n+1]):
                    out[m,n] = G[m,n]
...
def double_thresholding(img, high, low):
    ...
    weak_edges = np.where((img>low) & (img<=high), 1, 0)
